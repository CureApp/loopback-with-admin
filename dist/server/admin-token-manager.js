var ADMIN_USER, AdminToken, AdminTokenManager, DEFAULT_TOKEN, ONE_YEAR, ____, promisify,
...
AdminTokenManager = (function() {
  ...
  AdminTokenManager.prototype.updateTokens = function(tokenStrs) {
    var tokens;
    tokens = tokenStrs.map(function(tokenStr) {
      return new AdminToken(tokenStr);
    });
    ...
    return this.findById(token.id).then((function(_this) {
      return function(foundToken) {
        if (foundToken != null) {
          ...
          if (foundToken.userId !== ADMIN_USER.id) {
  ...
  AdminTokenManager.prototype.createAdminUser = function() {
    ...
    return promisify((function(_this) {
      return function(cb) {
        return User.create(ADMIN_USER, cb);
      };
    })(this));
  };
