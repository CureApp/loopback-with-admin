...
Main = (function() {
  ...
  Main.run = function(loopbackDefinitions, config, options) {
    ...
    return this.launchLoopback(adminOptions).then((function(_this) {
  ...
  Main.launchLoopback = function(adminOptions) {
    var server;
    server = new LoopbackServer();
    return server.launch(adminOptions).then((function(_this) {
      return function() {
        return server;
      };
    })(this));
