...
Main = (function() {
  ...
  Main.run = function(loopbackDefinitions, config, options) {
    ...
    return this.launchLoopback(generated.config, adminOptions, options.participantToken).then((function(_this) {
  ...
  Main.launchLoopback = function(serverConfig, adminOptions, participantToken) {
    var server;
    server = new LoopbackServer();
    return server.launch(serverConfig.server, adminOptions, participantToken).then((function(_this) {
      return function() {
        return server;
      };
    })(this));
