var AdminTokenManager, LoopbackServer, ParticipantTokenSetter, normalize;
...
LoopbackServer = (function() {
  ...
  LoopbackServer.prototype.launch = function(options, participantToken) {
    if (options == null) {
      options = {};
    }
    return new Promise((function(_this) {
      return function(resolve, reject) {
        _this.app = require(_this.entryPath)(options);
        _this.app.lwaTokenManager = new AdminTokenManager(options);
        if (participantToken) {
          _this.app.participantTokenSetter = new ParticipantTokenSetter(participantToken);
        }
